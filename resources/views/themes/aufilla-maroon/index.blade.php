        ...
        <div class="max-w-md mx-auto space-y-10">
          ...
          <div class="bg-white rounded-3xl border border-gold-500/20 shadow-xl overflow-hidden glass-premium relative" data-aos="fade-up" data-aos-duration="1200">
            ...
            <div class="p-8 truncate-normal">
              ...
              <div class="mt-8">
                <a href="{{ $akad->gmaps_link ?: 'https://www.google.com/maps/search/?api=1&query=' . urlencode($akad->tempat . ' ' . $akad->alamat) }}" target="_blank" class="inline-flex items-center justify-center gap-2 w-full bg-maroon-800 hover:bg-maroon-900 text-white font-medium text-xs tracking-wider uppercase px-6 py-3 rounded-2xl shadow-lg border border-gold-500/25 transition-all duration-300">
          ...
          <div class="bg-white rounded-3xl border border-gold-500/20 shadow-xl overflow-hidden glass-premium relative" data-aos="fade-up" data-aos-duration="1200">
            ...
            <div class="p-8">
              ...
              <!-- Google Maps Link Button -->
              <div class="mt-8">
                <a href="{{ $resepsi->gmaps_link ?: 'https://www.google.com/maps/search/?api=1&query=' . urlencode($resepsi->tempat . ' ' . $resepsi->alamat) }}" target="_blank" class="inline-flex items-center justify-center gap-2 w-full bg-maroon-800 hover:bg-maroon-900 text-white font-medium text-xs tracking-wider uppercase px-6 py-3 rounded-2xl shadow-lg border border-gold-500/25 transition-all duration-300">
                  <i class="fa-solid fa-map-marked-alt text-gold-400"></i>
                  <span>Petunjuk Lokasi Google Maps</span>
                </a>
              </div>
