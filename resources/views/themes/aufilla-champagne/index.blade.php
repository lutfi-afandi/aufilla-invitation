...
<body class="font-sans text-stone-800 bg-[#FDF8F6] relative selection:bg-primary-800 selection:text-white locked">
  ...
  <div class="min-h-screen lg:flex lg:h-[calc(100vh-2rem)] lg:m-4 lg:rounded-2xl lg:border-[12px] lg:border-[#452719] lg:outline lg:outline-[2px] lg:outline-[#D4AF37] lg:outline-offset-[-12px] lg:shadow-2xl lg:overflow-hidden relative bg-[#FDF8F6]">
    ...
    <div id="cover-screen" class="fixed lg:absolute inset-0 lg:left-auto lg:w-[480px] lg:right-0 z-50 flex items-center justify-center transition-all duration-1000 ease-in-out bg-cover bg-center"
      style="background-image: linear-gradient(to bottom, rgba(49,28,18,0.85) 0%, rgba(69,39,25,0.9) 60%, rgba(28,15,10,0.95) 100%), url('{{ $invitation->cover_img ? asset('storage/' . $invitation->cover_img) : ($invitation->theme?->thumbnail ? asset('storage/' . $invitation->theme->thumbnail) : asset('assets/img/thumbnail-tema/demo1.png')) }}');">
      <!-- Ornaments -->
    ...
    <div class="hidden lg:flex lg:flex-1 lg:h-full bg-gradient-to-br from-[#311C12] to-[#452719] p-16 flex-col justify-between relative bg-cover bg-center overflow-hidden"
      style="background-image: linear-gradient(135deg, rgba(49,28,18,0.92) 0%, rgba(69,39,25,0.85) 100%), url('{{ $invitation->cover_img ? asset('storage/' . $invitation->cover_img) : ($invitation->theme?->thumbnail ? asset('storage/' . $invitation->theme->thumbnail) : asset('assets/img/thumbnail-tema/demo1.png')) }}');">
