...
evaluasi:
ini secara warna kok masih identik banget dengan soraya pilot ya? apakah rose emang begini atau bisa lebih pink?
kalau rose yang dimaksud sudah identik dengan soraya pilot, lebih baik batalkan saja ganti dengan 
<head>
  <meta charset="UTF-8">
    ...
    tailwind.config = {
      theme: {
        extend: {
          colors: {
            brand: {
              900: '#5c2a36', // Dark brown/maroon as in reference
              800: '#7A3B4A',
              700: '#984e5f',
            },
            accent: '#C49B7A', // Dark goldenrod
          },
          fontFamily: {
  ...
  <style>
    ...
    /* Ornament Patterns */
    .ornament-dots {
      background-image: radial-gradient(circle, rgba(122,59,74,0.04) 1.5px, transparent 1.5px);
    ...
    .ornament-corner::after {
      ...
      width: 120px;
      height: 120px;
      border: 1.5px solid rgba(122,59,74,0.08);
...
<body class="font-sans text-stone-800 bg-[#FFF5F5] relative selection:bg-brand-800 selection:text-white locked">
  ...
  <div id="main-wrapper" class="w-full relative min-h-screen overflow-x-hidden">
    ...
    <div id="main-content" class="w-full relative opacity-0 pointer-events-none">
      ...
      <section id="event" class="relative py-24 px-6 bg-[#FFF5F5] overflow-hidden ornament-dots">
        
        <div class="max-w-4xl mx-auto flex flex-col items-center text-center mb-16" data-aos="fade-up">
           <div class="relative w-full max-w-[300px] mb-8">
             <div class="absolute top-1/2 left-0 right-0 h-[1px] bg-brand-800/30"></div>
             <h2 class="font-script text-6xl md:text-7xl text-brand-800 relative z-10 bg-[#FFF5F5] px-6 inline-block">Wedding <br><span class="ml-12">Event</span></h2>
           </div>
        </div>
      ...
      <!-- RSVP & GIFT -->
      <section id="rsvp" class="relative py-24 px-6 bg-[#FFF5F5] overflow-hidden ornament-dots ornament-corner">
