...
<head>
    ...
    <!-- SEO & Meta Tags -->
    <meta name="description" content="Buat undangan pernikahan digital premium, elegan, dan mudah digunakan. Bagikan momen kebahagiaan Anda tanpa batas dengan Aufilla Invitation.">
    <meta name="keywords" content="undangan pernikahan digital, undangan online, undangan website, buat undangan digital, aufilla invitation, undangan premium">
...
<body class="font-sans antialiased text-brand-dark bg-brand-bg overflow-x-hidden">
    ...
    <section class="relative pt-[140px] pb-20 md:pt-[180px] md:pb-28 overflow-hidden min-h-screen flex items-center bg-brand-bg">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
            {{-- Base Image --}}
            <img src="{{ asset('assets/img/wedding-aesthetic-bg.jpg') }}" alt="Wedding Aesthetic Background" class="w-full h-full object-cover grayscale opacity-40 mix-blend-multiply">
    ...
    <section id="fitur" class="py-24 px-6 lg:px-10 bg-white relative overflow-hidden">
        ...
        <svg class="absolute top-32 right-10 md:right-32 w-6 h-6 md:w-8 md:h-8 text-brand-accent/20 anim-float pointer-events-none z-0 hidden sm:block" style="animation-delay: -2s" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            ...
            $features = [
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />', 'title' => 'Unlimited Share'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />', 'title' => 'Custom Nama Tamu'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />', 'title' => 'Buku Tamu & RSVP'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />', 'title' => 'Gallery Foto & Video'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />', 'title' => 'Countdown Acara'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />', 'title' => 'Amplop Digital'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />', 'title' => 'Ucapan dan Doa'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />', 'title' => 'Cerita Cinta'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
            <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />', 'title' => 'Navigasi Lokasi'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />', 'title' => 'Backsound Musik'],
            ['icon' => '
            <path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />', 'title' => 'Free Revisi'],
            ];
            @endphp
    ...
    <section id="tema" class="py-24 px-6 lg:px-10 bg-brand-bg relative overflow-hidden">
        ...
        <svg class="absolute bottom-40 left-10 md:left-20 w-5 h-5 text-brand-accent/30 anim-float pointer-events-none z-0 hidden sm:block" style="animation-delay: -4s" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 0C12 6.627 17.373 12 24 12C17.373 12 12 17.373 12 24C12 17.373 6.627 12 0 12C6.627 12 12 6.627 12 0Z" />
        </svg>
    ...
    <section id="harga" class="py-24 px-6 lg:px-10 bg-white relative overflow-hidden">
        ...
        <svg class="absolute top-20 left-10 md:left-40 w-6 h-6 text-brand-accent/20 anim-float pointer-events-none z-0 hidden sm:block" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 0C12 6.627 17.373 12 24 12C17.373 12 12 17.373 12 24C12 17.373 6.627 12 0 12C6.627 12 12 6.627 12 0Z" />
        </svg>
        <svg class="absolute bottom-32 right-10 md:right-20 w-8 h-8 text-brand-dark/10 anim-float pointer-events-none z-0 hidden sm:block" style="animation-delay: -1s" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 0C12 6.627 17.373 12 24 12C17.373 12 12 17.373 12 24C12 17.373 6.627 12 0 12C6.627 12 12 6.627 12 0Z" />
        </svg>
                        ...
                        <ul class="space-y-4 mb-10 flex-1">
                            <li class="flex items-center gap-3 text-[13px] {{ $isPremium ? 'text-white/90' : 'text-brand-dark/80' }}">
                                <div class="w-5 h-5 rounded-full bg-brand-accent/20 flex items-center justify-center shrink-0">
                                    <svg class="w-3 h-3 {{ $isPremium ? 'text-brand-accent' : 'text-brand-accent' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                                    </svg>
                                </div>
                            ...
                            <li class="flex items-center gap-3 text-[13px] {{ $isPremium ? 'text-white/90' : 'text-brand-dark/80' }}">
                                <div class="w-5 h-5 rounded-full bg-brand-accent/20 flex items-center justify-center shrink-0">
                                    <svg class="w-3 h-3 text-brand-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                                    </svg>
                                </div>
    ...
    <section id="faq" class="py-16 md:py-20 px-6 lg:px-10 bg-brand-bg relative overflow-hidden">
        ...
        <svg class="absolute top-1/3 left-10 md:left-32 w-5 h-5 text-brand-accent/20 anim-float pointer-events-none z-0 hidden sm:block" style="animation-delay: -3s" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 0C12 6.627 17.373 12 24 12C17.373 12 12 17.373 12 24C12 17.373 6.627 12 0 12C6.627 12 12 6.627 12 0Z" />
        </svg>
                    ...
                    <div onclick="openThemePickerModal()" class="w-full bg-brand-bg border border-brand-dark/5 rounded-xl px-4 py-3 text-left flex items-center justify-between cursor-pointer hover:border-brand-accent transition-all group shadow-sm hover:shadow-md">
                        <div class="flex items-center gap-4">
                            <div id="register-theme-thumbnail" class="w-12 h-12 rounded-lg bg-white border border-brand-dark/10 overflow-hidden flex items-center justify-center shadow-sm">
                                <svg class="w-6 h-6 text-brand-dark/20" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        ...
                        <div class="w-8 h-8 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:bg-brand-accent transition-colors">
                            <svg class="w-4 h-4 text-brand-dark/40 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
    ...
    <script>
        ...
        pickerModal.addEventListener('click', e => {
            if (e.target === pickerModal) closeThemePickerModal();
        });
